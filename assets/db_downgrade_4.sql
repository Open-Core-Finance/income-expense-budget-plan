...
CREATE TEMPORARY TABLE temp2 AS
     SELECT uid, name, icon, "system", localize_names, position_index, last_updated, last_sync FROM asset_category;
...
INSERT INTO asset_category (uid, name, icon, "system", localize_names, position_index, last_updated, last_sync)
    SELECT uid, name, icon, "system", localize_names, position_index, last_updated, last_sync FROM temp2;
DROP TABLE temp2;
...
INSERT INTO asset (uid, icon, name, description, available_amount, loan_amount, credit_limit, payment_limit,
  ...
  SELECT uid, icon, name, description, available_amount, loan_amount, credit_limit, payment_limit, currency_uid,
    asset_type, category_uid, localize_names, localize_descriptions, position_index, last_updated, last_sync
  FROM temp;
DROP TABLE temp;

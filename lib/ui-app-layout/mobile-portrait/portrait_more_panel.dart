              ...
              if (context.mounted) {
                Util().navigateTo(
                  ...
                  ChangeNotifierProvider(
                    ...
                    child: TransactionCategoriesPanelPortrait(listPanelTitle: appLocalizations.menuExpenseCategory),
                  ),
                );
              }
            });
              ...
              if (context.mounted) {
                Util().navigateTo(
                  ...
                  ChangeNotifierProvider(
                    create: (context) => model,
                    builder: (context, child) => child!,
                    child: TransactionCategoriesPanelPortrait(listPanelTitle: appLocalizations.menuIncomeCategory),
                  ),
                );
              }
            });
